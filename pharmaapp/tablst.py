...
(catid integer primary key autoincrement,catname varchar(50) not null)"
...
pytype varchar(20) not null,vno integer not null,paidamt integer,pystatus boolean,\
dbid integer references deliveryboytab(dbid), dbdate date)"
...
tamt varchar(20) not null,tdisc varchar(20) not null,igst integer,idate date,oid integer)"
